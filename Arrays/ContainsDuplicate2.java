...
- Iterate through the array:
    - i = 0: Add 1 to the HashSet. HashSet = {1}
    - i = 1: Add 2 to the HashSet. HashSet = {1, 2}
    - i = 2: Add 3 to the HashSet. HashSet = {1, 2, 3}
    - i = 3: Check if 1 is in the HashSet. It is, so return true.
- The output is true, which matches the expected result.
